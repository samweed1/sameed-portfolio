...
function PortfolioPage({ dark, card, border, text, muted, bg }) {
  ...
  const logos = [
    ...
    { title: "Baltic Breeze", desc: "An illustrative hexagonal mark blending urban skyline with natural landscape — trees, mountains, and a rising sun. It captures the spirit of a place where nature and modernity coexist beautifully.", tags: ["Logo", "Illustrative", "Nature"], color: "#5B8FA8", img: IMG_BALTIC_BREEZE },
    ...
    { title: "Kingdom Joint", desc: "A bold, retro-style badge logo for a shawarma restaurant brand. The hand-illustrated shawarma spit wrapped in a ribbon banner creates instant personality — street food with serious swagger.", tags: ["Logo", "Badge", "Food"], color: "#E63946", img: IMG_KINGDOM_JOINT_LOGO },
    { title: "Brandy Vibes", desc: "A neon-lit bag icon glowing with electric pink energy. Designed for a women's accessories brand, this mark captures the thrill of the night out — bold, unapologetic, and completely unforgettable.", tags: ["Logo", "Neon", "Fashion"], color: "#E040FB", img: IMG_BRANDY_VIBES },
    ...
    { title: "CZ Connect", desc: "A clean, minimal wordmark with a subtle connectivity nod in the letterforms. The restrained palette and precise spacing make this mark feel modern, digital, and effortlessly professional.", tags: ["Logo", "Wordmark", "Tech"], color: "#2B2BE5", img: IMG_CZ_CONNECT },
  ];
